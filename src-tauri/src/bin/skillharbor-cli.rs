...
#[derive(Parser, Debug)]
#[command(name = "skillharbor-cli")]
#[command(about = "Shared-core CLI for SkillHarbor", version)]
struct Cli {
...
enum GitCommand {
    ...
    /// Remove refs/skillharbor/* (and pre-rebrand refs/skills-manager/*) that
    /// a `git push --mirror`/--all style operation uploaded to the backup
    /// remote. Local sync refs are kept.
    PruneSyncRefs,
}
