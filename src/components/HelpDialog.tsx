...
export function HelpDialog() {
  ...
  return <DetailSheet open={helpOpen} title={t("help.title")} description={t("help.description")} onClose={closeHelp}>
    <div className="space-y-3">          {(["workflows", "presets", "install", "sync", "global", "projects", "backup", "settings"] as const).map((key, index) => {
